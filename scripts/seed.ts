        ...
        await db.insert(schema.challenges).values([
            {
                ...
                explanation:
                    "This question asks you to identify 'the man' among the given options.",
                order: 1,
            },
            {
                id: 2,
                ...
                question: '"the man"',
                explanation:
                    "This assistive challenge helps you understand what 'the man' represents.",
                order: 2,
            },
            {
                id: 3,
                ...
                explanation:
                    "This question asks you to identify 'the robot' among the given options.",
                order: 3,
            },
        ]);
        ...
        await db.insert(schema.challenges).values([
            {
                ...
                explanation:
                    "This question asks you to identify 'the woman' among the given options.",
                order: 1,
            },
            {
                id: 5,
                ...
                question: '"the woman"',
                explanation:
                    "This assistive challenge helps you understand what 'the woman' represents.",
                order: 2,
            },
            {
                id: 6,
                ...
                explanation:
                    "This question asks you to identify 'the zombie' among the given options.",
                order: 3,
            },
        ]);
        ...
        await db.insert(schema.challenges).values([
            {
                ...
                explanation:
                    "This question asks you to identify 'the boy' among the given options.",
                order: 1,
            },
            {
                id: 8,
                ...
                question: '"the boy"',
                explanation:
                    "This assistive challenge helps you understand what 'the boy' represents.",
                order: 2,
            },
            {
                id: 9,
                ...
                explanation:
                    "This question asks you to identify 'the girl' among the given options.",
                order: 3,
            },
        ]);
