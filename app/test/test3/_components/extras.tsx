...
const extras: Extra[] = [
    {
        ...
        imageSrc: "/landing_page/extras/image_1.png",
    ...
    },
    {
        ...
        linkHref: "/gift",
        imageSrc: "/landing_page/extras/image_2.png",
    ...
    },
    {
        ...
        linkText: "Contact",
        linkHref: "/contact",
        imageSrc: "/landing_page/extras/image_3.png",
        ...
        <section className="container mx-auto px-6 py-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {extras.map((ex, idx) => (
                    <div
                        key={idx}
                        className="flex flex-col border bg-white rounded-2xl p-6 shadow-sm hover:shadow-md transition h-full"
                    >
                        {/* Icon */}
