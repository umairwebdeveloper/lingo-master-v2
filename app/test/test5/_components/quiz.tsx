...
export default function Quiz({
    ...
    const getChoiceClasses = (choice: any, i: number) => {
        ...
        if (choice.isCorrect) return "border-green-400 bg-green-50";
        if (i === a.response) return "border-red-400 bg-red-50";
    ...
    const getLetterClasses = (choice: any, i: number) => {
        ...
        if (choice.isCorrect) return "bg-green-700 text-white";
        if (i === a.response) return "bg-red-700 text-white";
