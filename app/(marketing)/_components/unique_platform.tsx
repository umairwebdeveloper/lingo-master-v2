...
export default function UniquePlatform() {
    return (
        <section id="howWorks" className="bg-gray-50">
            <div className="container mx-auto px-6 py-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                    {features.map((feat, idx) => (
                        <div
                            key={idx}
                            className={`bg-white rounded-2xl overflow-hidden shadow-sm p-4 transform transition-transform duration-300 hover:scale-105 ${
