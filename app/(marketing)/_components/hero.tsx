        ...
        >
            ...
            <div className="relative container mx-auto px-6 py-32 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-36 items-center">
                ...
                <div className="space-y-4">
                    ...
                    <div className="mt-8 flex flex-col md:flex-row items-center md:items-start justify-center md:justify-start space-y-4 md:space-y-0 md:space-x-4">
                        <button
                            onClick={() => {
                                const pricing =
                        ...
                        <ClerkLoaded>
                            <SignedIn>
                                <a
                                    href="/dashboard"
                                    className="inline-block bg-gray-200 text-gray-800 px-6 py-3 rounded-full font-medium hover:bg-gray-300 transition"
                                >
                                    Ga naar Dashboard
                                </a>
                            </SignedIn>
